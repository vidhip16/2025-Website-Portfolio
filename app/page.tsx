...
function Starfield() {
  ...
  const starsRef = useRef<Array<{ x: number; y: number; r: number; baseA: number; t: number }>>([])
  ...
  useEffect(() => {
    ...
    const step = () => {
      ...
      // Shooting stars
      if (Math.random() < 0.015 && shootersRef.current.length < 3) {
      ...
      <section id="resume" className="min-h-screen py-32 px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          >
            ...
            <Button asChild variant="outline" className="bg-transparent border-pink-500/30 text-pink-400 hover:bg-pink-500/10 hover:border-pink-500/50">
